def cargaGaseosa(amigo_1:dict=0,amigo_2:dict=0,amigo_3:dict=0,misDatos:dict={})->dict:
    ...
    if s1 and s2 and s3:
        ...
        return {'contador': contador}, {1: amigo_1['nombre'], 2: amigo_2['nombre']}
    elif s1 and s3:
        return {'contador': contador}, {1: amigo_1['nombre'], 3: amigo_3['nombre']}
    elif s2 and s3:
        return {'contador': contador}, {2: amigo_2['nombre'], 3: amigo_3['nombre']}
    elif s1:
        return {'contador': contador}, {1: amigo_1['nombre']}
    elif s2:
        return {'contador': contador}, {2: amigo_2['nombre']}
    elif s3:
        return {'contador': contador}, {3: amigo_3['nombre']}
    else:
        return {'contador': contador}, None
